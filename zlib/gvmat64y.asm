...
%ifdef INFOZIP
	...
	common					window_size			4	; :DWORD
	common					window				1	; :BYTE:010040H
	common					prev				2	; :WORD:08000H
	common					strstart			4	; :DWORD
	common					match_start			4	; :DWORD
	common					prev_length			4	; :DWORD ; PrevLen
	common					max_chain_length	4	; :DWORD
	common					good_match			4	; :DWORD
	common					nice_match			4	; :DWORD

%define prev_ad				prev
%define window_ad			window
...
%define Lookahead			rcx + dsLookahead
