...
public class crypt
{
	...
	****************************************************************************/
	...
	public const int MODE_GCM  = 5; // GCM
	public const int MODE_LAST = 6; // Last possible crypt mode value
	...
	****************************************************************************/
	...
	public const int CERTINFO_TRUSTED_USAGE                      = 2010; // Usage that cert is trusted for
	public const int CERTINFO_TRUSTED_IMPLICIT                   = 2011; // Whether cert is implicitly trusted
	public const int CERTINFO_SIGNATURELEVEL                     = 2012; // Amount of detail to include in sigs.
	public const int CERTINFO_VERSION                            = 2013; // Cert.format version
	public const int CERTINFO_SERIALNUMBER                       = 2014; // Serial number
	public const int CERTINFO_SUBJECTPUBLICKEYINFO               = 2015; // Public key
	public const int CERTINFO_CERTIFICATE                        = 2016; // User certificate
	public const int CERTINFO_USERCERTIFICATE                    = 2016;
	public const int CERTINFO_CACERTIFICATE                      = 2017; // CA certificate
	public const int CERTINFO_ISSUERNAME                         = 2018; // Issuer DN
	public const int CERTINFO_VALIDFROM                          = 2019; // Cert valid-from time
	public const int CERTINFO_VALIDTO                            = 2020; // Cert valid-to time
	public const int CERTINFO_SUBJECTNAME                        = 2021; // Subject DN
	public const int CERTINFO_ISSUERUNIQUEID                     = 2022; // Issuer unique ID
	public const int CERTINFO_SUBJECTUNIQUEID                    = 2023; // Subject unique ID
	public const int CERTINFO_CERTREQUEST                        = 2024; // Cert.request (DN + public key)
	public const int CERTINFO_THISUPDATE                         = 2025; // CRL/OCSP current-update time
	public const int CERTINFO_NEXTUPDATE                         = 2026; // CRL/OCSP next-update time
	public const int CERTINFO_REVOCATIONDATE                     = 2027; // CRL/OCSP cert-revocation time
	public const int CERTINFO_REVOCATIONSTATUS                   = 2028; // OCSP revocation status
	public const int CERTINFO_CERTSTATUS                         = 2029; // RTCS certificate status
	public const int CERTINFO_DN                                 = 2030; // Currently selected DN in string form
	...
	public const int CERTINFO_IPADDRESSBLOCKS_ADDRESSFAMILY      = 2218; // addressFamily
	public const int CERTINFO_IPADDRESSBLOCKS_INHERIT            = 2219;
	public const int CERTINFO_IPADDRESSBLOCKS_PREFIX             = 2220; // ipAddress.addressPrefix
	public const int CERTINFO_IPADDRESSBLOCKS_MIN                = 2221; // ipAddress.addressRangeMin
	public const int CERTINFO_IPADDRESSBLOCKS_MAX                = 2222; // ipAddress.addressRangeMax
	public const int CERTINFO_AUTONOMOUSSYSIDS                   = 2223; // CRYPT_CERTINFO_AUTONOMOUSSYSIDS_ASNUM_INHERIT,// asNum.inherit
	public const int CERTINFO_AUTONOMOUSSYSIDS_ASNUM_INHERIT     = 2224;
	public const int CERTINFO_AUTONOMOUSSYSIDS_ASNUM_ID          = 2225; // asNum.id
	public const int CERTINFO_AUTONOMOUSSYSIDS_ASNUM_MIN         = 2226; // asNum.min
	public const int CERTINFO_AUTONOMOUSSYSIDS_ASNUM_MAX         = 2227; // asNum.max
	public const int CERTINFO_OCSP_NONCE                         = 2228; // nonce
	public const int CERTINFO_OCSP_RESPONSE                      = 2229;
	public const int CERTINFO_OCSP_RESPONSE_OCSP                 = 2230; // OCSP standard response
	public const int CERTINFO_OCSP_NOCHECK                       = 2231; // 1 3 6 1 5 5 7 48 1 6 ocspArchiveCutoff
	public const int CERTINFO_OCSP_ARCHIVECUTOFF                 = 2232; // 1 3 6 1 5 5 7 48 1 11 subjectInfoAccess
	public const int CERTINFO_SUBJECTINFOACCESS                  = 2233;
	public const int CERTINFO_SUBJECTINFO_TIMESTAMPING           = 2234; // accessDescription.accessLocation
	public const int CERTINFO_SUBJECTINFO_CAREPOSITORY           = 2235; // accessDescription.accessLocation
	public const int CERTINFO_SUBJECTINFO_SIGNEDOBJECTREPOSITORY = 2236; // accessDescription.accessLocation
	public const int CERTINFO_SUBJECTINFO_RPKIMANIFEST           = 2237; // accessDescription.accessLocation
	public const int CERTINFO_SUBJECTINFO_SIGNEDOBJECT           = 2238; // accessDescription.accessLocation
	public const int CERTINFO_SIGG_DATEOFCERTGEN                 = 2239; // 1 3 36 8 3 2 siggProcuration
	public const int CERTINFO_SIGG_PROCURATION                   = 2240;
	public const int CERTINFO_SIGG_PROCURE_COUNTRY               = 2241; // country
	public const int CERTINFO_SIGG_PROCURE_TYPEOFSUBSTITUTION    = 2242; // typeOfSubstitution
	public const int CERTINFO_SIGG_PROCURE_SIGNINGFOR            = 2243; // signingFor.thirdPerson
	public const int CERTINFO_SIGG_ADMISSIONS                    = 2244;
	public const int CERTINFO_SIGG_ADMISSIONS_AUTHORITY          = 2245; // authority
	public const int CERTINFO_SIGG_ADMISSIONS_NAMINGAUTHID       = 2246; // namingAuth.iD
	public const int CERTINFO_SIGG_ADMISSIONS_NAMINGAUTHURL      = 2247; // namingAuth.uRL
	public const int CERTINFO_SIGG_ADMISSIONS_NAMINGAUTHTEXT     = 2248; // namingAuth.text
	public const int CERTINFO_SIGG_ADMISSIONS_PROFESSIONITEM     = 2249; // professionItem
	public const int CERTINFO_SIGG_ADMISSIONS_PROFESSIONOID      = 2250; // professionOID
	public const int CERTINFO_SIGG_ADMISSIONS_REGISTRATIONNUMBER = 2251; // registrationNumber
	public const int CERTINFO_SIGG_MONETARYLIMIT                 = 2252;
	public const int CERTINFO_SIGG_MONETARY_CURRENCY             = 2253; // currency
	public const int CERTINFO_SIGG_MONETARY_AMOUNT               = 2254; // amount
	public const int CERTINFO_SIGG_MONETARY_EXPONENT             = 2255; // exponent
	public const int CERTINFO_SIGG_DECLARATIONOFMAJORITY         = 2256;
	public const int CERTINFO_SIGG_DECLARATIONOFMAJORITY_COUNTRY = 2257; // fullAgeAtCountry
	public const int CERTINFO_SIGG_RESTRICTION                   = 2258; // 1 3 36 8 3 13 siggCertHash
	public const int CERTINFO_SIGG_CERTHASH                      = 2259; // 1 3 36 8 3 15 siggAdditionalInformation
	public const int CERTINFO_SIGG_ADDITIONALINFORMATION         = 2260; // 1 3 101 1 4 1 strongExtranet
	public const int CERTINFO_STRONGEXTRANET                     = 2261;
	public const int CERTINFO_STRONGEXTRANET_ZONE                = 2262; // sxNetIDList.sxNetID.zone
	public const int CERTINFO_STRONGEXTRANET_ID                  = 2263; // sxNetIDList.sxNetID.id
	public const int CERTINFO_SUBJECTDIRECTORYATTRIBUTES         = 2264;
	public const int CERTINFO_SUBJECTDIR_TYPE                    = 2265; // attribute.type
	public const int CERTINFO_SUBJECTDIR_VALUES                  = 2266; // attribute.values
	public const int CERTINFO_SUBJECTKEYIDENTIFIER               = 2267; // 2 5 29 15 keyUsage
	public const int CERTINFO_KEYUSAGE                           = 2268; // 2 5 29 16 privateKeyUsagePeriod
	public const int CERTINFO_PRIVATEKEYUSAGEPERIOD              = 2269;
	public const int CERTINFO_PRIVATEKEY_NOTBEFORE               = 2270; // notBefore
	public const int CERTINFO_PRIVATEKEY_NOTAFTER                = 2271; // notAfter
	public const int CERTINFO_SUBJECTALTNAME                     = 2272; // 2 5 29 18 issuerAltName
	public const int CERTINFO_ISSUERALTNAME                      = 2273; // 2 5 29 19 basicConstraints
	public const int CERTINFO_BASICCONSTRAINTS                   = 2274;
	public const int CERTINFO_CA                                 = 2275; // cA
	public const int CERTINFO_AUTHORITY                          = 2275;
	public const int CERTINFO_PATHLENCONSTRAINT                  = 2276; // pathLenConstraint
	public const int CERTINFO_CRLNUMBER                          = 2277; // 2 5 29 21 cRLReason
	public const int CERTINFO_CRLREASON                          = 2278; // 2 5 29 23 holdInstructionCode
	public const int CERTINFO_HOLDINSTRUCTIONCODE                = 2279; // 2 5 29 24 invalidityDate
	public const int CERTINFO_INVALIDITYDATE                     = 2280; // 2 5 29 27 deltaCRLIndicator
	public const int CERTINFO_DELTACRLINDICATOR                  = 2281; // 2 5 29 28 issuingDistributionPoint
	public const int CERTINFO_ISSUINGDISTRIBUTIONPOINT           = 2282;
	public const int CERTINFO_ISSUINGDIST_FULLNAME               = 2283; // distributionPointName.fullName
	public const int CERTINFO_ISSUINGDIST_USERCERTSONLY          = 2284; // onlyContainsUserCerts
	public const int CERTINFO_ISSUINGDIST_CACERTSONLY            = 2285; // onlyContainsCACerts
	public const int CERTINFO_ISSUINGDIST_SOMEREASONSONLY        = 2286; // onlySomeReasons
	public const int CERTINFO_ISSUINGDIST_INDIRECTCRL            = 2287; // indirectCRL
	public const int CERTINFO_CERTIFICATEISSUER                  = 2288; // 2 5 29 30 nameConstraints
	public const int CERTINFO_NAMECONSTRAINTS                    = 2289;
	public const int CERTINFO_PERMITTEDSUBTREES                  = 2290; // permittedSubtrees
	public const int CERTINFO_EXCLUDEDSUBTREES                   = 2291; // excludedSubtrees
	public const int CERTINFO_CRLDISTRIBUTIONPOINT               = 2292;
	public const int CERTINFO_CRLDIST_FULLNAME                   = 2293; // distributionPointName.fullName
	public const int CERTINFO_CRLDIST_REASONS                    = 2294; // reasons
	public const int CERTINFO_CRLDIST_CRLISSUER                  = 2295; // cRLIssuer
	public const int CERTINFO_CERTIFICATEPOLICIES                = 2296;
	public const int CERTINFO_CERTPOLICYID                       = 2297; // policyInformation.policyIdentifier
	public const int CERTINFO_CERTPOLICY_CPSURI                  = 2298; // policyInformation.policyQualifiers.qualifier.cPSuri
	public const int CERTINFO_CERTPOLICY_ORGANIZATION            = 2299; // policyInformation.policyQualifiers.qualifier.userNotice.noticeRef.organization
	public const int CERTINFO_CERTPOLICY_NOTICENUMBERS           = 2300; // policyInformation.policyQualifiers.qualifier.userNotice.noticeRef.noticeNumbers
	public const int CERTINFO_CERTPOLICY_EXPLICITTEXT            = 2301; // policyInformation.policyQualifiers.qualifier.userNotice.explicitText
	public const int CERTINFO_POLICYMAPPINGS                     = 2302;
	public const int CERTINFO_ISSUERDOMAINPOLICY                 = 2303; // policyMappings.issuerDomainPolicy
	public const int CERTINFO_SUBJECTDOMAINPOLICY                = 2304; // policyMappings.subjectDomainPolicy
	public const int CERTINFO_AUTHORITYKEYIDENTIFIER             = 2305;
	public const int CERTINFO_AUTHORITY_KEYIDENTIFIER            = 2306; // keyIdentifier
	public const int CERTINFO_AUTHORITY_CERTISSUER               = 2307; // authorityCertIssuer
	public const int CERTINFO_AUTHORITY_CERTSERIALNUMBER         = 2308; // authorityCertSerialNumber
	public const int CERTINFO_POLICYCONSTRAINTS                  = 2309;
	public const int CERTINFO_REQUIREEXPLICITPOLICY              = 2310; // policyConstraints.requireExplicitPolicy
	public const int CERTINFO_INHIBITPOLICYMAPPING               = 2311; // policyConstraints.inhibitPolicyMapping
	public const int CERTINFO_EXTKEYUSAGE                        = 2312;
	public const int CERTINFO_EXTKEY_MS_INDIVIDUALCODESIGNING    = 2313; // individualCodeSigning
	public const int CERTINFO_EXTKEY_MS_COMMERCIALCODESIGNING    = 2314; // commercialCodeSigning
	public const int CERTINFO_EXTKEY_MS_CERTTRUSTLISTSIGNING     = 2315; // certTrustListSigning
	public const int CERTINFO_EXTKEY_MS_TIMESTAMPSIGNING         = 2316; // timeStampSigning
	public const int CERTINFO_EXTKEY_MS_SERVERGATEDCRYPTO        = 2317; // serverGatedCrypto
	public const int CERTINFO_EXTKEY_MS_ENCRYPTEDFILESYSTEM      = 2318; // encrypedFileSystem
	public const int CERTINFO_EXTKEY_SERVERAUTH                  = 2319; // serverAuth
	public const int CERTINFO_EXTKEY_CLIENTAUTH                  = 2320; // clientAuth
	public const int CERTINFO_EXTKEY_CODESIGNING                 = 2321; // codeSigning
	public const int CERTINFO_EXTKEY_EMAILPROTECTION             = 2322; // emailProtection
	public const int CERTINFO_EXTKEY_IPSECENDSYSTEM              = 2323; // ipsecEndSystem
	public const int CERTINFO_EXTKEY_IPSECTUNNEL                 = 2324; // ipsecTunnel
	public const int CERTINFO_EXTKEY_IPSECUSER                   = 2325; // ipsecUser
	public const int CERTINFO_EXTKEY_TIMESTAMPING                = 2326; // timeStamping
	public const int CERTINFO_EXTKEY_OCSPSIGNING                 = 2327; // ocspSigning
	public const int CERTINFO_EXTKEY_DIRECTORYSERVICE            = 2328; // directoryService
	public const int CERTINFO_EXTKEY_ANYKEYUSAGE                 = 2329; // anyExtendedKeyUsage
	public const int CERTINFO_EXTKEY_NS_SERVERGATEDCRYPTO        = 2330; // serverGatedCrypto
	public const int CERTINFO_EXTKEY_VS_SERVERGATEDCRYPTO_CA     = 2331; // serverGatedCrypto CA
	public const int CERTINFO_CRLSTREAMIDENTIFIER                = 2332; // 2 5 29 46 freshestCRL
	public const int CERTINFO_FRESHESTCRL                        = 2333;
	public const int CERTINFO_FRESHESTCRL_FULLNAME               = 2334; // distributionPointName.fullName
	public const int CERTINFO_FRESHESTCRL_REASONS                = 2335; // reasons
	public const int CERTINFO_FRESHESTCRL_CRLISSUER              = 2336; // cRLIssuer
	public const int CERTINFO_ORDEREDLIST                        = 2337; // 2 5 29 51 baseUpdateTime
	public const int CERTINFO_BASEUPDATETIME                     = 2338; // 2 5 29 53 deltaInfo
	public const int CERTINFO_DELTAINFO                          = 2339;
	public const int CERTINFO_DELTAINFO_LOCATION                 = 2340; // deltaLocation
	public const int CERTINFO_DELTAINFO_NEXTDELTA                = 2341; // nextDelta
	public const int CERTINFO_INHIBITANYPOLICY                   = 2342; // 2 5 29 58 toBeRevoked
	public const int CERTINFO_TOBEREVOKED                        = 2343;
	public const int CERTINFO_TOBEREVOKED_CERTISSUER             = 2344; // certificateIssuer
	public const int CERTINFO_TOBEREVOKED_REASONCODE             = 2345; // reasonCode
	public const int CERTINFO_TOBEREVOKED_REVOCATIONTIME         = 2346; // revocationTime
	public const int CERTINFO_TOBEREVOKED_CERTSERIALNUMBER       = 2347; // certSerialNumber
	public const int CERTINFO_REVOKEDGROUPS                      = 2348;
	public const int CERTINFO_REVOKEDGROUPS_CERTISSUER           = 2349; // certificateIssuer
	public const int CERTINFO_REVOKEDGROUPS_REASONCODE           = 2350; // reasonCode
	public const int CERTINFO_REVOKEDGROUPS_INVALIDITYDATE       = 2351; // invalidityDate
	public const int CERTINFO_REVOKEDGROUPS_STARTINGNUMBER       = 2352; // startingNumber
	public const int CERTINFO_REVOKEDGROUPS_ENDINGNUMBER         = 2353; // endingNumber
	public const int CERTINFO_EXPIREDCERTSONCRL                  = 2354; // 2 5 29 63 aaIssuingDistributionPoint
	public const int CERTINFO_AAISSUINGDISTRIBUTIONPOINT         = 2355;
	public const int CERTINFO_AAISSUINGDIST_FULLNAME             = 2356; // distributionPointName.fullName
	public const int CERTINFO_AAISSUINGDIST_SOMEREASONSONLY      = 2357; // onlySomeReasons
	public const int CERTINFO_AAISSUINGDIST_INDIRECTCRL          = 2358; // indirectCRL
	public const int CERTINFO_AAISSUINGDIST_USERATTRCERTS        = 2359; // containsUserAttributeCerts
	public const int CERTINFO_AAISSUINGDIST_AACERTS              = 2360; // containsAACerts
	public const int CERTINFO_AAISSUINGDIST_SOACERTS             = 2361; // containsSOAPublicKeyCerts
	public const int CERTINFO_NS_CERTTYPE                        = 2362; // netscape-cert-type
	public const int CERTINFO_NS_BASEURL                         = 2363; // netscape-base-url
	public const int CERTINFO_NS_REVOCATIONURL                   = 2364; // netscape-revocation-url
	public const int CERTINFO_NS_CAREVOCATIONURL                 = 2365; // netscape-ca-revocation-url
	public const int CERTINFO_NS_CERTRENEWALURL                  = 2366; // netscape-cert-renewal-url
	public const int CERTINFO_NS_CAPOLICYURL                     = 2367; // netscape-ca-policy-url
	public const int CERTINFO_NS_SSLSERVERNAME                   = 2368; // netscape-ssl-server-name
	public const int CERTINFO_NS_COMMENT                         = 2369; // netscape-comment
	public const int CERTINFO_SET_HASHEDROOTKEY                  = 2370;
	public const int CERTINFO_SET_ROOTKEYTHUMBPRINT              = 2371; // rootKeyThumbPrint
	public const int CERTINFO_SET_CERTIFICATETYPE                = 2372; // 2 23 42 7 2 SET merchantData
	public const int CERTINFO_SET_MERCHANTDATA                   = 2373;
	public const int CERTINFO_SET_MERID                          = 2374; // merID
	public const int CERTINFO_SET_MERACQUIRERBIN                 = 2375; // merAcquirerBIN
	public const int CERTINFO_SET_MERCHANTLANGUAGE               = 2376; // merNames.language
	public const int CERTINFO_SET_MERCHANTNAME                   = 2377; // merNames.name
	public const int CERTINFO_SET_MERCHANTCITY                   = 2378; // merNames.city
	public const int CERTINFO_SET_MERCHANTSTATEPROVINCE          = 2379; // merNames.stateProvince
	public const int CERTINFO_SET_MERCHANTPOSTALCODE             = 2380; // merNames.postalCode
	public const int CERTINFO_SET_MERCHANTCOUNTRYNAME            = 2381; // merNames.countryName
	public const int CERTINFO_SET_MERCOUNTRY                     = 2382; // merCountry
	public const int CERTINFO_SET_MERAUTHFLAG                    = 2383; // merAuthFlag
	public const int CERTINFO_SET_CERTCARDREQUIRED               = 2384; // 2 23 42 7 4 SET tunneling
	public const int CERTINFO_SET_TUNNELING                      = 2385;
	public const int CERTINFO_SET_TUNNELLING                     = 2385;
	public const int CERTINFO_SET_TUNNELINGFLAG                  = 2386; // tunneling
	public const int CERTINFO_SET_TUNNELLINGFLAG                 = 2386;
	public const int CERTINFO_SET_TUNNELINGALGID                 = 2387; // tunnelingAlgID
	public const int CERTINFO_SET_TUNNELLINGALGID                = 2387; // S/MIME attributes
	...
	public const int CERTINFO_CMS_SMIMECAP_IDEA                  = 2509; // IDEA encryption
	public const int CERTINFO_CMS_SMIMECAP_RC2                   = 2510; // RC2 encryption (w.128 key)
	public const int CERTINFO_CMS_SMIMECAP_RC5                   = 2511; // RC5 encryption (w.128 key)
	public const int CERTINFO_CMS_SMIMECAP_SKIPJACK              = 2512; // Skipjack encryption
	public const int CERTINFO_CMS_SMIMECAP_DES                   = 2513; // DES encryption
	public const int CERTINFO_CMS_SMIMECAP_SHAng                 = 2514; // SHA2-ng hash
	public const int CERTINFO_CMS_SMIMECAP_SHA2                  = 2515; // SHA2-256 hash
	public const int CERTINFO_CMS_SMIMECAP_SHA1                  = 2516; // SHA1 hash
	public const int CERTINFO_CMS_SMIMECAP_HMAC_SHAng            = 2517; // HMAC-SHA2-ng MAC
	public const int CERTINFO_CMS_SMIMECAP_HMAC_SHA2             = 2518; // HMAC-SHA2-256 MAC
	public const int CERTINFO_CMS_SMIMECAP_HMAC_SHA1             = 2519; // HMAC-SHA1 MAC
	public const int CERTINFO_CMS_SMIMECAP_AUTHENC256            = 2520; // AuthEnc w.256-bit key
	public const int CERTINFO_CMS_SMIMECAP_AUTHENC128            = 2521; // AuthEnc w.128-bit key
	public const int CERTINFO_CMS_SMIMECAP_RSA_SHAng             = 2522; // RSA with SHA-ng signing
	public const int CERTINFO_CMS_SMIMECAP_RSA_SHA2              = 2523; // RSA with SHA2-256 signing
	public const int CERTINFO_CMS_SMIMECAP_RSA_SHA1              = 2524; // RSA with SHA1 signing
	public const int CERTINFO_CMS_SMIMECAP_DSA_SHA1              = 2525; // DSA with SHA-1 signing
	public const int CERTINFO_CMS_SMIMECAP_ECDSA_SHAng           = 2526; // ECDSA with SHA-ng signing
	public const int CERTINFO_CMS_SMIMECAP_ECDSA_SHA2            = 2527; // ECDSA with SHA2-256 signing
	public const int CERTINFO_CMS_SMIMECAP_ECDSA_SHA1            = 2528; // ECDSA with SHA-1 signing
	public const int CERTINFO_CMS_SMIMECAP_PREFERSIGNEDDATA      = 2529; // preferSignedData
	public const int CERTINFO_CMS_SMIMECAP_CANNOTDECRYPTANY      = 2530; // canNotDecryptAny
	public const int CERTINFO_CMS_SMIMECAP_PREFERBINARYINSIDE    = 2531; // preferBinaryInside
	public const int CERTINFO_CMS_RECEIPTREQUEST                 = 2532;
	public const int CERTINFO_CMS_RECEIPT_CONTENTIDENTIFIER      = 2533; // contentIdentifier
	public const int CERTINFO_CMS_RECEIPT_FROM                   = 2534; // receiptsFrom
	public const int CERTINFO_CMS_RECEIPT_TO                     = 2535; // receiptsTo
	public const int CERTINFO_CMS_SECURITYLABEL                  = 2536;
	public const int CERTINFO_CMS_SECLABEL_POLICY                = 2537; // securityPolicyIdentifier
	public const int CERTINFO_CMS_SECLABEL_CLASSIFICATION        = 2538; // securityClassification
	public const int CERTINFO_CMS_SECLABEL_PRIVACYMARK           = 2539; // privacyMark
	public const int CERTINFO_CMS_SECLABEL_CATTYPE               = 2540; // securityCategories.securityCategory.type
	public const int CERTINFO_CMS_SECLABEL_CATVALUE              = 2541; // securityCategories.securityCategory.value
	public const int CERTINFO_CMS_MLEXPANSIONHISTORY             = 2542;
	public const int CERTINFO_CMS_MLEXP_ENTITYIDENTIFIER         = 2543; // mlData.mailListIdentifier.issuerAndSerialNumber
	public const int CERTINFO_CMS_MLEXP_TIME                     = 2544; // mlData.expansionTime
	public const int CERTINFO_CMS_MLEXP_NONE                     = 2545; // mlData.mlReceiptPolicy.none
	public const int CERTINFO_CMS_MLEXP_INSTEADOF                = 2546; // mlData.mlReceiptPolicy.insteadOf.generalNames.generalName
	public const int CERTINFO_CMS_MLEXP_INADDITIONTO             = 2547; // mlData.mlReceiptPolicy.inAdditionTo.generalNames.generalName
	public const int CERTINFO_CMS_CONTENTHINTS                   = 2548;
	public const int CERTINFO_CMS_CONTENTHINT_DESCRIPTION        = 2549; // contentDescription
	public const int CERTINFO_CMS_CONTENTHINT_TYPE               = 2550; // contentType
	public const int CERTINFO_CMS_EQUIVALENTLABEL                = 2551;
	public const int CERTINFO_CMS_EQVLABEL_POLICY                = 2552; // securityPolicyIdentifier
	public const int CERTINFO_CMS_EQVLABEL_CLASSIFICATION        = 2553; // securityClassification
	public const int CERTINFO_CMS_EQVLABEL_PRIVACYMARK           = 2554; // privacyMark
	public const int CERTINFO_CMS_EQVLABEL_CATTYPE               = 2555; // securityCategories.securityCategory.type
	public const int CERTINFO_CMS_EQVLABEL_CATVALUE              = 2556; // securityCategories.securityCategory.value
	public const int CERTINFO_CMS_SIGNINGCERTIFICATE             = 2557;
	public const int CERTINFO_CMS_SIGNINGCERT_ESSCERTID          = 2558; // certs.essCertID
	public const int CERTINFO_CMS_SIGNINGCERT_POLICIES           = 2559; // policies.policyInformation.policyIdentifier
	public const int CERTINFO_CMS_SIGNINGCERTIFICATEV2           = 2560;
	public const int CERTINFO_CMS_SIGNINGCERTV2_ESSCERTIDV2      = 2561; // certs.essCertID
	public const int CERTINFO_CMS_SIGNINGCERTV2_POLICIES         = 2562; // policies.policyInformation.policyIdentifier
	public const int CERTINFO_CMS_SIGNATUREPOLICYID              = 2563;
	public const int CERTINFO_CMS_SIGPOLICYID                    = 2564; // sigPolicyID
	public const int CERTINFO_CMS_SIGPOLICYHASH                  = 2565; // sigPolicyHash
	public const int CERTINFO_CMS_SIGPOLICY_CPSURI               = 2566; // sigPolicyQualifiers.sigPolicyQualifier.cPSuri
	public const int CERTINFO_CMS_SIGPOLICY_ORGANIZATION         = 2567; // sigPolicyQualifiers.sigPolicyQualifier.userNotice.noticeRef.organization
	public const int CERTINFO_CMS_SIGPOLICY_NOTICENUMBERS        = 2568; // sigPolicyQualifiers.sigPolicyQualifier.userNotice.noticeRef.noticeNumbers
	public const int CERTINFO_CMS_SIGPOLICY_EXPLICITTEXT         = 2569; // sigPolicyQualifiers.sigPolicyQualifier.userNotice.explicitText
	public const int CERTINFO_CMS_SIGTYPEIDENTIFIER              = 2570;
	public const int CERTINFO_CMS_SIGTYPEID_ORIGINATORSIG        = 2571; // originatorSig
	public const int CERTINFO_CMS_SIGTYPEID_DOMAINSIG            = 2572; // domainSig
	public const int CERTINFO_CMS_SIGTYPEID_ADDITIONALATTRIBUTES = 2573; // additionalAttributesSig
	public const int CERTINFO_CMS_SIGTYPEID_REVIEWSIG            = 2574; // reviewSig
	public const int CERTINFO_CMS_NONCE                          = 2575; // randomNonce
	public const int CERTINFO_SCEP_MESSAGETYPE                   = 2576; // messageType
	public const int CERTINFO_SCEP_PKISTATUS                     = 2577; // pkiStatus
	public const int CERTINFO_SCEP_FAILINFO                      = 2578; // failInfo
	public const int CERTINFO_SCEP_SENDERNONCE                   = 2579; // senderNonce
	public const int CERTINFO_SCEP_RECIPIENTNONCE                = 2580; // recipientNonce
	public const int CERTINFO_SCEP_TRANSACTIONID                 = 2581; // transID
	public const int CERTINFO_CMS_SPCAGENCYINFO                  = 2582;
	public const int CERTINFO_CMS_SPCAGENCYURL                   = 2583; // spcAgencyInfo.url
	public const int CERTINFO_CMS_SPCSTATEMENTTYPE               = 2584;
	public const int CERTINFO_CMS_SPCSTMT_INDIVIDUALCODESIGNING  = 2585; // individualCodeSigning
	public const int CERTINFO_CMS_SPCSTMT_COMMERCIALCODESIGNING  = 2586; // commercialCodeSigning
	public const int CERTINFO_CMS_SPCOPUSINFO                    = 2587;
	public const int CERTINFO_CMS_SPCOPUSINFO_NAME               = 2588; // spcOpusInfo.name
	public const int CERTINFO_CMS_SPCOPUSINFO_URL                = 2589; // spcOpusInfo.url
	public const int CERTINFO_LAST                               = 2590;
	...
	****************************************************************************/
	...
	public const int SSLOPTION_NONE                           = 0x00;
	public const int SSLOPTION_MINVER_SSLV3                   = 0x00; // Min.protocol version
	public const int SSLOPTION_MINVER_TLS10                   = 0x01;
	public const int SSLOPTION_MINVER_TLS11                   = 0x02;
