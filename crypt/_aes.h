...
aes_rval ASM_EXPORT aes_encrypt(const unsigned char *in, unsigned char *out, const aes_encrypt_ctx cx[1]);
...
aes_rval ASM_EXPORT aes_decrypt(const unsigned char *in, unsigned char *out, const aes_decrypt_ctx cx[1]);
