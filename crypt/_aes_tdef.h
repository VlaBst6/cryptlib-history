...
#  elif defined( __BORLANDC__ )
  /* The 16-bit compiler doesn't know about 64-bit types, so we don't try
     and define them if we're building the 16-bit version */
  #ifndef  __MSDOS__
...
#if defined( USE_ASM ) && defined( __WATCOMC__ ) && !defined( ASM_EXPORT )
