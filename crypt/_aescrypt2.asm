...
; This code requires either ASM_V2 or ASM_V2C to be set in aesopt.h and the 
; same define to be set here as well. If AES_V2C is set this file requires 
; the C files aeskey.c and aestab.c for support.
...
;
; where <Z> is ASM_V2 or ASM_V2C.  The calling intefaces are:
;
...
;
;     aes_rval aes_encrypt_key<NNN>(const unsigned char key[],
;                                            const aes_encrypt_ctx cx[1]);
;
;     aes_rval aes_decrypt_key<NNN>(const unsigned char key[],
;                                            const aes_decrypt_ctx cx[1]);
;
;     aes_rval aes_encrypt_key(const unsigned char key[],
;                           unsigned int len, const aes_decrypt_ctx cx[1]);
;
;     aes_rval aes_decrypt_key(const unsigned char key[],
;                           unsigned int len, const aes_decrypt_ctx cx[1]);
;
