...
#define t_use(m,n) t_##m##n
  ...
  #else
	#define CONST const
  #endif /* 16-bit systems with limited BSS space */
#else
#define CONST
#endif
...
#define d_1(t,n,b,e)       ALIGN CONST ASM_EXPORT t n[256]    =   b(e)
#define d_4(t,n,b,e,f,g,h) ALIGN CONST ASM_EXPORT t n[4][256] = { b(e), b(f), b(g), b(h) }
EXTERN ALIGN CONST uint_32t t_dec(r,c)[RC_LENGTH] = rc_data(w0);
#else
#define d_1(t,n,b,e)       EXTERN ALIGN CONST ASM_EXPORT t n[256]
#define d_4(t,n,b,e,f,g,h) EXTERN ALIGN CONST ASM_EXPORT t n[4][256]
